...
class BankFileStore {
	...
	public  void createAccount(Writer bf, BufferedReader br) throws IOException {
		String accNum = readUserInput("Enter Account number");
		int  accountNum = Integer.parseInt(accNum);
		boolean accountFound = isAccountInTheFile(br, accountNum);
		if(accountFound){
	...
	public boolean isAccountInTheFile(BufferedReader br, int accountNumbet) throws NumberFormatException, IOException{
		boolean accountFound =false ;
